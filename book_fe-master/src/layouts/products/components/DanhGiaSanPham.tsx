...
const DanhGiaSanPham: React.FC<DanhGiaSanPhamProps> = ({ maSach }) => {
  ...
  const [userName, setUserName] = useState<NguoiDungModel| null>(null);
  ...
  return (
    <div className="review-section my-4">
          ...
          >
            <div className="mb-3">
              ...
              <select
                ...
                onChange={(e) =>
                  setDanhGiaMoi({
                    ...danhGiaMoi,
                    diemXepHang: Number(e.target.value),
                  })
                }
                style={{ color: '#ffc107' }} // Thêm màu vàng cho text
              >
            ...
            <div className="mb-3">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setDanhGiaMoi({ ...danhGiaMoi, nhanXet: e.target.value })
                }
                required
              />
            </div>
            <button
              ...
              onClick={async () => {
                ...
                await fetch(
                  "http://localhost:8080/api/danh-gia/them-danh-gia-v1",
                  {
                    method: "POST",
                    headers: {
      ...
      <div className="00000000000000000000000000"></div>
        ...
        {danhSachDanhGia.map((danhGia) => (
          <div key={danhGia.maDanhGia} className="review-item card mb-3">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center mb-2">
                <div>
                  ...
                  <span className="fw-bold">
                    {userInfo ? `${userInfo.sub}` : 'Người dùng'}
                  </span>
                </div>
              ...
              <p className="review-content mb-0">{danhGia.nhanXet}</p>
            </div>
          </div>
        ))}
      </div>
